...
<li class="activ"><a href="java.php">JAVA</a>
<div class="submenu1">
<ul>
...
<li class="activ"><a href="java_Conditional.php">ConditinalStatements</a></li>
...
<button id="next-btn">Next</button>
      ...
      <form id="history-form" method="post" action="java_Conditional.php">
...
{      
question:" age=19;<br>if(age<18)<br>{<br>cout<<“You have no right to Vote”;<br> }",  
answers:[       
{ 
...
{ 
question:"If a expression in if statement is true the code in the else block will be Excuted", 
answers:[    
{
