...
<li class="activ"><a href="python_formattedoutput.php">FormattedOutput</a></li>
...
<button id="next-btn">Next</button>
      ...
      <form id="history-form" method="post" action="python_formattedoutput.php">
...
{
question:"print() statement is used for ?",
answers:[     
{ 
...
{ 
question:"We can use Print instead of print.(TRUE or FALSE)?", 
answers:[    
{
