...
<div class="submenu1">
<ul>
<li class="activ"><a href="c++_basic.php">Basic</a></li>
...
<button id="next-btn">Next</button>
      ...
      <form id="history-form" method="post" action="c++_basic.php">
...
const questions=[ 
{  
question:"Who devoloped C++ Programming Language?", 
answers:[      
{ 
   ...
   {
   text: "Bejarne Stoustrup",correct:true
},] 
},
...
{      
question:" C++ is used for devoloping ?",  
answers:[       
{ 
...
{        
question:" C++ was devoloped in which year ?", 
answers:[    
{
