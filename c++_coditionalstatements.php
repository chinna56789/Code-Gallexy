...
<li class="activ"><a href="c++_coditionalstatements.php">ConditionalStatements</a></li>
...
<button id="next-btn">Next</button>
      ...
      <form id="history-form" method="post" action="c++_coditionalstatements.php">
...
{      
question:" age=19;if(age<18){cout<<“You have no right to Vote”;}",  
answers:[       
{ 
