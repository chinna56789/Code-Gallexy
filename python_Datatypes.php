...
<li class="activ"><a href="python_Datatypes.php">Datatypes</a></li>
...
{
question:"Which of the following datatypes are In Python ?",
answers:[     
{ 
     text: "Primitive Datatypes",correct:false
	 },   
     { 
     text: "User defined Datatypes",correct:false
	 },  
     {
     text: "Derived Datatypes",correct:false
	 }, 
     {
...
{      
question:" What are the user Defined datatypes in Python ?",  
answers:[       
{ 
...
{ 
question:"Size and Format Specifier of character Datatype ?", 
answers:[    
{
         text:"2 bytes, %d",correct:false
		 },  
     {
         text:"4 bytes, %s",correct:false
		 }, 
     {
         text:"8 byte , %f",correct:false
		 },  
         { 
         text:"1 byte, %c",correct:false
		 },] 
 },
 

{        
question:" Which of the following datatype has decimal point ?", 
answers:[    
{
