...
<li class="activ"><a href="java_Variables.php">Variables</a></li>
...
const questions=[ 
{  
question:"Variables are ?", 
answers:[      
{ 
   text: "Containers for storing data",correct:true
   },  
   {
...
{
question:"How to declare a variable ?",
answers:[     
{ 
...
answers:[       
{ 
       text: "float =1.5;",correct:false
	   }, 	
       {
       text: "float num:1.5;",correct:false
},
{
       text: "float-num-1.5;",correct:false
},
{
       text: "float num=1.5;",correct:true
},
...
{ 
question:"Variable Name can be a keyword (TRUE of FALSE) ?", 
answers:[    
{
...
{        
question:" int a=10;<br> System.out.println(a);", 
answers:[    
{
