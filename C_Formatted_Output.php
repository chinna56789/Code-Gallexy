...
<li class="activ"><a href="c_Formatted_Output.php">FormattedOutput</a></li>
...
<button id="next-btn">Next</button>
      ...
      <form id="history-form" method="post" action="C_Formatted_Output.php">
...
const questions=[ 
{  
question:"Which of the following is used as Formatted Output?", 
answers:[      
{ 
...
{
question:"printf() statement is used for?",
answers:[     
{ 
...
{      
question:"We can use Printf() instead of printf().(TRUE or FALSE)?",  
answers:[       
{ 
...
{ 
question:"Escape sequences are prefixed with______?",
answers:[    
{
         text:"%",correct:false
		 },   
...
{        
question:"Format Specifier Used for Integer Datatype ?", 
answers:[    
{
      text:"%d",correct:true
	  },     
