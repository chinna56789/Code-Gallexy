...
<li class="activ"><a href="java_Arrays.php">Arrays</a></li>
...
answers:[     
{ 
     text: "One Dimensitional array",correct:false
	 },   
     { 
     text: "Multi Dimensitional array",correct:false
	 },  
     {
     text: "Two Dimensitional array",correct:false
	 }, 
     {
...
{      
question:" arr(3)={1,2,3,4} ; error ?",  
answers:[       
{ 
       text: "Array values must be enclosed with “ ” ",correct:false
	   }, 	
       {
       text: "Size of array must be in square braces []",correct:true
},
{
       text: "Array can store only 3 values",correct:false
},
{
       text: "We should not use arr as variable",correct:false
},
...
{ 
question:"Array index starts with 1.(TRUE or FALSE)?", 
answers:[    
{
