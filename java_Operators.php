...
<li class="activ"><a href="java_Operators.php">Operators</a></li>
...
<button id="next-btn">Next</button>
      ...
      <form id="history-form" method="post" action="java_Operators.php">
...
{
question:"Which of the following Operators are used in Java ?",
answers:[     
{ 
