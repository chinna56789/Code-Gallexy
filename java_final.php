...
<li><a href="java_constructors.php">Constructors</a></li>
<li><a href="java_Classes.php">Classes,Objects</a></li>
<li><a href="java_Inheritence.php">Inheritence</a></li>
<li class="activ"><a href="java_final.php">FinalQuiz</a></li>
...
{
question:"Java is used for devoloping ?",
answers:[     
{ 
 ...
     {
     text: "Big dat Technology",correct:false
	 }, 
     {
...
{      
question:" A Pointer is a derived Datatype that can store ?",  
answers:[       
{ 
       text: "The address of that variable",correct:false
	   }, 	
       {
       text: "The size of another variable",correct:false
},
{
       text: "The memory location of another variable",correct:true
},
{
       text: "The address of that variable",correct:false
},
...
{      
question:"A class consists of ? ",  
answers:[       
{ 
       text: "Data menmbers",correct:false
	   }, 	
       {
       text: "Both",correct:true
},
{
       text: "Member Functions",correct:false
},
{
...
{      
question:"A function can be Overloaded by ? ",  
answers:[       
{ 
       text: "Changing Datatype",correct:false
	   }, 	
       {
       text: "Changing Number of Arguments",correct:false
},
{
       text: "Both",correct:true
},
...
{      
question:"Switch is a ? ",  
answers:[       
{ 
       text: "Oneway Branch Statement",correct:false
	   }, 	
       {
       text: "Multiway Branch Statement",correct:true
},
{
       text: "Biway Branch Statement",correct:false
},
{
       text: "None",correct:false
},
...
{ 
question:"We can use Scanner without using a variable(TRUE or FALSE)?", 
answers:[    
{
...
{        
question:" Java was devoloped in which year ?", 
answers:[    
{
