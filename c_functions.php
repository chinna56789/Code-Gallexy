...
<li class="activ"><a href="c_functions.php">Functions</a></li>
...
answers:[      
{ 
   text: "Set of statements that performs a specific task",correct:true
   },  
   {
   text: "Set of Arthematic Operations",correct:false
   },
   { 
...
{      
question:" int sum(int a ,int b);<br>Here a and b are? ",  
answers:[       
{ 
...
{
       text: "Function parameters",correct:true
},
{
       text: "Function operands",correct:false
},
...
{ 
question:"Functions which are pre defined are known as user Defined Functions.(TRUE or FALSE)?", 
answers:[    
{
...
{        
question:"What is the order of Writing a Function ?", 
answers:[    
{
      text:"Declararation – Call - Defination",correct:false
	  },     
      {
      text:"Definition – call - Declaration",correct:false
	  },  
      { 
      text:"Call – Declaration – Defination",correct:false
	  },     
      {
      text:"Declaration – Defination – Call",correct:true
	  }]
 }];
