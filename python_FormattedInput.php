...
<li class="activ"><a href="python_FormattedInput.php">FormattedInput</a></li>
...
<button id="next-btn">Next</button>
      ...
      <form id="history-form" method="post" action="python_FormattedInput.php">
...
{ 
question:"We can use input() without using a variable(TRUE or FALSE)?", 
answers:[    
{
