...
<li><a href="python_Inheritance.php">Inheritence</a></li>
<li class="activ"><a href="python_FinalQuiz.php">FinalQuiz</a></li>
...
<button id="next-btn">Next</button>
      ...
      <form id="history-form" method="post" action="python_FinalQuiz.php">
...
const questions=[ 
{  
question:"Python is used for devoloping ?", 
answers:[      
{ 
   text: "Web Devlopment",correct:false
   },  
   {
...
{
question:"Datatype Specifies the ?",
answers:[     
{ 
     text: "Order of Data",correct:false
	 },   
     { 
     text: "Sequence of Data",correct:false
	 },  
     {
     text: "Name of the Variable",correct:false
	 }, 
     {
     text: "Type of Data",correct:true
},] 
},

{
question:"input() statement is used for ?",
answers:[     
{ 
...
{
question:"Which Operator Performs operation only on one Operand ?",
answers:[     
{ 
     text: "Relational Opeartor",correct:false
	 },   
     { 
     text: "Bitwise Operator",correct:false
	 },  
     {
     text: "Conditional Operator",correct:false
	 }, 
     {
     text: "Unary Operator",correct:true
},] 
}, 
...
{
question:"Which the following are types of Array ?",
answers:[     
{ 
     text: "One Dimensional array",correct:false
	 },   
     { 
     text: "Two Dimensional array",correct:false
	 },  
     {
     text: "Multi Dimensional array",correct:false
	 }, 
     {
     text: "All the above",correct:true
},] 
...
{        
question:" Which of the following are conditional Statements ?", 
answers:[    
{
 ...
      {
      text:"All Ahe above",correct:true
	  }]
 }];
