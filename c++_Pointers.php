...
<li class="activ"><a href="c++_Pointers.php">Pointers</a></li>
...
<button id="next-btn">Next</button>
      ...
      <form id="history-form" method="post" action="c++_Pointers.php">
...
{      
question:" int a=10; <br> int *b=&a; <br> cout<<*b; <br> What may be the output ?",  
answers:[       
{ 
