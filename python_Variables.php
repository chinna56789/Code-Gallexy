...
<li class="activ"><a href="python_Variables.php">Variables</a></li>
...
<li><a href="python_Inheritance.php">Inheritance</a></li>
...
<button id="next-btn">Next</button>
      ...
      <form id="history-form" method="post" action="python_Variables.php">
