...
<li class="activ"><a href="c++_Final.php">FinalQuiz</a></li>
...
const questions=[ 
{  
question:"Why comments are used ?", 
answers:[      
{ 
   text: "To reduce the code",correct:false
   },  
   {
   text: "To understand the Code",correct:true
   },
   { 
   text: "To test a single module of code",correct:false
   },  
   {
...
{
question:"Format Specifier Used for float Datatype ?",
answers:[     
{ 
...
{ 
       ...
       {
       text: "Collection of data of same type",correct:true
},
{
       text: "Collection of Data of different type",correct:false
},
{
       text: "None",correct:false
},
...
{      
question:" Which of the following are Pointer types ?",  
answers:[       
{ 
       text: "Null Pointer",correct:false
	   }, 	
       {
       text: "Array Pointer",correct:false
},
{
       text: "Function Pointer",correct:false
},
{
...
{ 
question:"An object is a Instance of a class.(TRUE or FALSE)", 
answers:[    
{
...
{      
question:" How to Initilize a String ?",  
answers:[       
{ 
       text: "string name[]=”Vinay”;",correct:false
	   }, 	
       {
       text: "char name[]=”Rohith”;",correct:true
},
{
       text: "string name=”Venkat”;",correct:false
},
{
       text: "char name=”Arif”;",correct:false
},
...
{      
question:" An object is Defined as a ?",  
answers:[       
{ 
       text: "Data Field that has unique attributes",correct:false
	   }, 	
       {
       text: "Data Field that has many attributes",correct:false
},
{
       text: "Data Field that has unique behaviour",correct:false
},
{
       text: "Data Field that has unique attributes and Behaviour",correct:true
},
...
answers:[    
{
      text:"Object Oriented Programming Language",correct:true
	  },     
      {
      text:"Procedure Oriented Programming Language",correct:false
	  },  
      { 
