...
<li class="activ"><a href="c_looping.php">LoopingStatements</a></li>
...
const questions=[ 
{  
question:"Which of the following are Looping Statements?", 
answers:[      
{ 
 ...
   {
   text: "Al the above",correct:true
},] 
},
 
 
{
question:"Which of the following is a Exit control Loop ?",
answers:[     
{ 
     text: "while",correct:false
	 },   
 ...
     {
     text: "while,for",correct:false
},] 
}, 
 
 
{      
question:" Syntax for for Loop?",  
answers:[       
{ 
       text: "for(initilize expression ; update expression)",correct:false
	   }, 	
       {
       text: "for(initilize expression ; test expression ; update expression);",correct:false
},
{
       text: "for(initilize expression ; test expression ; update expression)",correct:true
},
{
       text: "for(initilize expression : test expression : update expression);",correct:false
},
...
{ 
question:"A block of statements can be looped n number of times.(TRUE or FALSE)", 
answers:[    
{
...
{        
question:" for(i=0;i<10;i++) <br> { <br>prinf(i);<br> }", 
answers:[    
{
