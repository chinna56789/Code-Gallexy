...
<li class="activ"><a href="python_Conditional.php">ConditinalStatements</a></li>
...
<div class="quiz">
<h1>Conditinal Statements - Python</h1>
<div class="app">
...
<button id="next-btn">Next</button>
      ...
      <form id="history-form" method="post" action="python_Conditional.php">
...
{      
question:" age=19<br>if(age<18):<br>print(“You have no right to Vote”)",  
answers:[       
{ 
