...
<li class="activ"><a href="java_Classes.php">Classes,Objects</a></li>
<li><a href="java_Inheritance.php">Inheritence</a></li>
...
{      
question:" class student<br>{<br>int id;<br>string name[];<br>void result()<br>{<br>}<br>here id and name are known as ?",  
answers:[       
{ 
       text: "Member Functions",correct:false
	   }, 	
       {
       text: "Data members",correct:true
},
{
       text: "class Parameters",correct:false
},
{
       text: "none",correct:false
},
...
{        
question:" Which of the followinf is a scope Resolution Operators", 
answers:[    
{
      text:":",correct:false
	  },     
