...
<li class="activ"><a href="c_comments.php">Comments</a></li>
...
<button id="next-btn">Next</button>
      ...
      <form id="history-form" method="post" action="c_comments.php">
...
const questions=[ 
{  
question:"  Which of the Following Comment Lines in C ?", 
answers:[      
{ 
   text: "//",correct:false
   },  
...
{      
question:" print(“Jagan Mohan Reddy”); <br>      //print(“Pawan Kalyan”)",  
answers:[       
{ 
