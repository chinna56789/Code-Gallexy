...
<li class="activ"><a href="java_Comments.php">Comments</a></li>
...
<button id="next-btn">Next</button>
      ...
      <form id="history-form" method="post" action="java_Comments.php">
...
const questions=[ 
{  
question:"Which of the Following Comment Lines in Java ?", 
answers:[      
{ 
   text: "*/",correct:false
   },  
...
{        
question:" ystem.out.print(“Jagan Mohan Reddy”);<br> //System.out.print(“Pawan Kalyan”);", 
answers:[    
{
