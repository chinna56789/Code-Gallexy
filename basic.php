...
<div class="submenu1">
<ul>
<li class="activ"><a href="basic.php">Basic</a></li>	
...
<li><a href="python_final.php">FinalQuiz</a></li>
  ...
  <div class="quiz">
    ...
    <form id="history-form" method="post" action="basic.php">
    ...
    <script>
      const questions = [
        {
          question: "Who devoloped C Language?",
          answers: [
            {
...

        {
          ...
          answers: [
            {
              text: "Object Oriented Prograamming Language", correct: false
            },
            {
              text: "Procedural Oriented programming Language", correct: true
            },
            {
        ...
        {
          question: "C is a Interpreted Language.(TRUE or FALSE)",
          answers: [
            {
        ...
        {
          question: "C language is Used for Devoloping?",
          answers: [
            {
              text: "Web Designing", correct: false
            },
            {
              text: "Game Devolopment", correct: false
            },
            {
              text: "Android Application Devoloment", correct: false
            },
            {
              text: "Operating System UNIX", correct: true
            },]
        },


        {
          question: "C Language was Devoloped in which Year?",
          answers: [
            {
