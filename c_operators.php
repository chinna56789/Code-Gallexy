...
<li class="activ"><a href="c_operators.php">Operators</a></li>
...
<button id="next-btn">Next</button>
      ...
      <form id="history-form" method="post" action="c_operators.php">
...
{
question:"Which of the following  Operators are used in c ?",
answers:[     
{ 
     text: "Arthematic Operators ",correct:false
	 },   
     { 
...
answers:[    
{
      text:"Relatational Opeartor",correct:false
	  },     
      {
 ...
      {
      text:"Uninary Operator",correct:true
	  }]
 }];
