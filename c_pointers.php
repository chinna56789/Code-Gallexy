...
<li class="activ"><a href="c_pointers.php">Pointers</a></li>
...
{ 
 ...
   { 
   text: "The memory location of another variable",correct:false
   },  
   {
   text: "The address of another variable",correct:true
},] 
},
...
{      
question:" int a=10;<br>int *b=&a;<br>printf(“%p”,*b);<br>What may be the output ?",  
answers:[       
{ 
       text: "The address of variable b.",correct:false
	   }, 	
       {
       text: "The value of variable b.",correct:false
},
{
       text: "The address of variable a.",correct:true
},
{
       text: "The value of variable a.",correct:false
},
...
{ 
question:"* symobol can be replaced with & symbol.(TRUE or FALSE)?", 
answers:[    
{
