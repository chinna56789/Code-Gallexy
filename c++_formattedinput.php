...
<li class="activ"><a href="c++_formattedinput.php">FormattedInput</a></li>
...
<button id="next-btn">Next</button>
      ...
      <form id="history-form" method="post" action="c++_formattedinput.php">
        <input type="hidden" name="username" value="<?php echo htmlentities($_SESSION['uname']); ?>">
        <input type="hidden" name="course" value="C++">   
        <input type="hidden" name="subtopic" value="Foramatted Input">  
...
{
question:"cin>> statement is used for ?",
answers:[     
{ 
...
{      
question:" int num; cout<<“Enter a number”; cin>>num;",  
answers:[       
{ 
...
{ 
question:"We can use cin>> without using a variable(TRUE or FALSE)?", 
answers:[    
{
