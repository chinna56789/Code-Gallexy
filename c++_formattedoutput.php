...
<li class="activ"><a href="c++_formattedoutput.php">FormattedOutput</a></li>
...
<button id="next-btn">Next</button>
      ...
      <form id="history-form" method="post" action="c++_formattedoutput.php">
        <input type="hidden" name="username" value="<?php echo htmlentities($_SESSION['uname']); ?>">
        <input type="hidden" name="course" value="C++">   
        <input type="hidden" name="subtopic" value="Foramatted Output">  
...
{
question:"cout() statement is used for ?",
answers:[     
{ 
...
{ 
question:"We can use Cout<< instead of cout<<.(TRUE or FALSE)?", 
answers:[    
{
