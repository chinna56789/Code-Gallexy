...
<li class="activ"><a href="c_formatted_input.php">FormattedInput</a></li>
...
<button id="next-btn">Next</button>
      ...
      <form id="history-form" method="post" action="c_formatted_input.php">
...
{      
question:" int num; <br>printf(“Enter a number”);<br>scanf(“%d”,num;);",  
answers:[       
{ 
...
{ 
question:"We can use scanf() without using a variable.(TRUE or FALSE)", 
answers:[    
{
