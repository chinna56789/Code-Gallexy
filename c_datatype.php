...
<li class="activ"><a href="c_datatype.php">Datatypes</a></li>
...
<button id="next-btn">Next</button>
      ...
      <form id="history-form" method="post" action="c_datatype.php">
...
{ 
 ...
     { 
     text: "User defined Datatypes",correct:true
	 },  
     {
...
{ 
question:"Size and Fomat Specifier of character Datatype ?", 
answers:[    
{
 ...
         { 
         text:"8 bytes,%f",correct:false
		 },
         {
         text:"1 bytes,%c",correct:true
		 },] 
 },
