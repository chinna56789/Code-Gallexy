...
<li class="activ"><a href="java_Datatypes.php">Datatypes</a></li>
...
<button id="next-btn">Next</button>
      ...
      <form id="history-form" method="post" action="java_Datatypes.php">
...
{
question:"Which of the following datatypes are In Java ?",
answers:[     
{ 
...
{      
question:" What are the Primitive datatypes in Java ?",  
answers:[       
{ 
...
answers:[    
{
 ...
         { 
     ...
     {
      text:"8 byte , %f",correct:
     },
     {
      text:"2 bytes, %d",correct:
     },
]
 },
