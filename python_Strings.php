...
<li class="activ"><a href="python_Strings.php">Strings</a></li>
...
<button id="next-btn">Next</button>
      ...
      <form id="history-form" method="post" action="python_Strings.php">
...
answers:[     
{ 
     text: "char name[]=”Rohith”",correct:false
	 },   
     { 
 ...
     {
     text: "name=”Vinay”",correct:true
},] 
}, 
 
 
{      
question:" name=”String”;<br> print(name[1])",  
answers:[       
{ 
