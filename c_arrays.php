...
<li class="activ"><a href="c_arrays.php">Arrays</a></li>
...
<button id="next-btn">Next</button>
      ...
      <form id="history-form" method="post" action="c_arrays.php">
...
{      
question:" arr(3)={1,2,3,4} ; <br> error?",  
answers:[       
{ 
...
{
       text: "Size of array mst be in square braces [ ]",correct:true
},
