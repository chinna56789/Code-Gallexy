...
<li class="activ"><a href="python_Functions.php">Functions</a></li>
...
<button id="next-btn">Next</button>
      ...
      <form id="history-form" method="post" action="python_Functions.php">
...
{ 
 ...
     { 
     text: "def function_name return_type()",correct:false
	 },  
     {
     text: "def return_type function_name(parameter 1,parameter n)",correct:true
	 }, 
     {
     text: "def function_name(parameter 1,parameter 2);",correct:false
},] 
}, 
 
 
{      
question:" def sum(int a ,int b)<br> Here a and b are ?",  
answers:[       
{ 
