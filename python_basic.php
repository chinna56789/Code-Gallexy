...
<button id="next-btn">Next</button>
      ...
      <form id="history-form" method="post" action="python_basic.php">
...
const questions=[ 
{  
question:"Who devoloped Python Programming Language?", 
answers:[      
{ 
...
answers:[       
{ 
       text: "Web Devovolopment",correct:false
	   }, 	
       {
...
{ 
question:"Python is a Interpreted Language.(TRUE or FALSE) ?", 
answers:[    
{
...
{        
question:" Python was devoloped in which year ?", 
answers:[    
{
