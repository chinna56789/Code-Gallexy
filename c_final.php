...
<li class="activ"><a href="c_final.php">FinalQuiz</a></li>
...
const questions=[ 
{  
question:"Which of the following statement is used as Formatted Output ?", 
answers:[      
{ 
...
{  
question:" What are the Primitive datatypes in C ?",     
answers:[       
{ 
       text: "Class,structure,union",correct:false
	   }, 	
       {
       text: "Integer,character,float,double",correct:true
},
{
       text: "    Function,array,pointer",correct:false
},
{
       text: "None",correct:false
},]
...
{      
question:" scanf() statement is used for ?",  
answers:[       
{ 
       text: "Displaying the Output",correct:false
	   }, 	
       {
       text: "Reading the Data",correct:true
},
{
       text: "Returning a Value",correct:false
},
{
       text: "Not used",correct:false
},]
},
{ 
question:"if(5<7);<br>{<br>}", 
answers:[    
{
         text:"Syntax Error",correct:true
		 },   
         { 
         text:"Logic Error",correct:false
		 },
		 { 
...
{        
question:" Syntax of break and continue ?", 
answers:[    
{
      text:"Break; , Continue;",correct:false
	  },     
      {
      text:"break; , continue;",correct:true
	  },  
      { 
      text:"break, continue",correct:false
	  },     
      {
	  ...
	  {       
question:" The size of an array is exactly ?", 
answers:[    
{
 ...
      {
	  ...
	  {      
question:" A String is a ?", 
answers:[    
{
      text:"Sequence of numbers",correct:false
	  },     
      {
      text:"Sequence of Characters",correct:true
	  },  
      { 
      text:"Sequence of data of Diffent type",correct:false
	  },     
      {
      text:"None",correct:false
	  },]
	  ...
	  {	    
question:" Syntax for Declaring a Pointer ?", 
answers:[    
{
      text:"datatype &variable_name;",correct:false
	  },     
      {
      text:"*datatype variable_name;",correct:false
	  },  
      { 
      text:"datatype *variable_name;",correct:true
	  },     
      {
      text:"All The Above",correct:false
	  },]
	  ...
	  {	    
question:" Syntax for Declaring a Function ?", 
answers:[    
{
      text:"function_name();",correct:false
	  },     
      {
      text:"function_name return_type();",correct:false
	  },  
      { 
      text:"return_type function_name(parameter 1,parameter n);",correct:true
	  },     
      {
      text:"function_name(parameter 1,parameter  2);",correct:false
	  },]
	  },
	  {	    
question:"Use of Break ?", 
answers:[    
{
      text:"Stops the Program Excution",correct:true
	  },     
      {
      text:"    Brings the program control to the ending of loop",correct:false
	  },  
      { 
      text:"Logical Operator",correct:false
	  },     
      {
      text:"    Skips the Program control",correct:false
	  },]
	  }];
