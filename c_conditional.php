...
<li class="activ"><a href="c_conditional.php">ConditionalStatements</a></li>
...
<div class="quiz">
<h1>Conditional Statements- C</h1>
<div class="app">
...
<button id="next-btn">Next</button>
      ...
      <form id="history-form" method="post" action="c_conditional.php">
        <input type="hidden" name="username" value="<?php echo htmlentities($_SESSION['uname']); ?>">
        <input type="hidden" name="course" value="C">   
        <input type="hidden" name="subtopic" value="Conditional Statements">  
...
{
question:"Which is a one way Excution Statement ?",
answers:[     
{ 
...
{      
question:" age=19;<br> if(age<18)<br>{<br>printf(“You have no right to Vote”);<br> }",  
answers:[       
{ 
       text: " You have no right to Vote",correct:false
	   }, 	
       {
       text: "You have right to vote",correct:false
},
{
       text: "Syntax Error",correct:false
},
{
       text: "Empty Screen",correct:true
},
...
{ 
question:"If a expression in if statement is true the code in the else block will be Excuted.(TRUE or FALSE)", 
answers:[    
{
 ...
 if(score===5)
{
   resetState();
 let  per=score/5*100; 
   questionElement.innerHTML =`You are OutStanding......You scored ${score} out of ${questions.length}! <br>PERCENTAGE :${per}% <br><br> <br><br> <?php echo htmlentities($_SESSION['uname']);?> `; 
...
else if(score==0)
{
   resetState(); 
  let per=score/5*100; 
   questionElement.innerHTML =`You are Very Poor......You scored ${score} out of ${questions.length}! <br>PERCENTAGE :${per}% <br><br> <br><br> <?php echo htmlentities($_SESSION['uname']);?> `;
   nextButton.innerHTML="Submit";  
   nextButton.style.display="block";
   document.getElementById("correctans").value = score;
   document.getElementById("percentage").value = per;
...
else if(score>2&&score<4)
{
   resetState(); 
  let per=score/5*100; 
   questionElement.innerHTML =`You are Average......You scored ${score} out of ${questions.length}!<br>PERCENTAGE :${per}% <br><br> <br><br> <?php echo htmlentities($_SESSION['uname']);?> `;
   nextButton.innerHTML="Submit";   
   nextButton.style.display="block";
   document.getElementById("correctans").value = score;
   document.getElementById("percentage").value = per;
