...
<li class="activ"><a href="c++_datatypes.php">Datatypes</a></li>
...
<button id="next-btn">Next</button>
      ...
      <form id="history-form" method="post" action="c++_datatypes.php">
...
{
question:"Which of the following datatypes are In C ?",
answers:[     
{ 
