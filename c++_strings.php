...
<li class="activ"><a href="c++_strings.php">Strings</a></li>
<li><a href="c++_coditionalstatements.php">ConditionalStatements</a></li>
...
{ 
   ...
   { 
   text: "Sequence of data of Different type",correct:false
   },  
   {
...
{      
question:" char name[]=”String”; cout<<name[1];",  
answers:[       
{ 
...
{ 
question:"Initilizing the size for a String is Mandatory.(TRUE or FALSE)?", 
answers:[    
{
...
{        
question:" Which of the following are String Functions ?", 
answers:[    
{
      text:"strcpy(), strcat()",correct:false
	  },     
      {
      text:"strlen(), strupr()",correct:false
	  },  
      { 
      text:"strcmp, strlwr()",correct:false
	  },     
      {
