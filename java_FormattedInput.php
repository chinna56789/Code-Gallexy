...
<li class="activ"><a href="java_FormattedInput.php">FormattedInput</a></li>
...
<button id="next-btn">Next</button>
      ...
      <form id="history-form" method="post" action="java_FormattedInput.php">
        <input type="hidden" name="username" value="<?php echo htmlentities($_SESSION['uname']); ?>">
        <input type="hidden" name="course" value="JAVA">   
        <input type="hidden" name="subtopic" value="Formatted Input">  
...
const questions=[ 
{  
question:"Which of the following statement is used as Formatted input ?", 
answers:[      
{ 
...
{
question:"Scanner statement is used for ?",
answers:[     
{ 
...
{      
question:" int num;<br>System.out.print(“Enter a number”);<br>num=sc.nextint();",  
answers:[       
{ 
       text: "Takes the input value",correct:true
	   }, 	
       {
       text: "Returns the input value",correct:false
},
{
       text: "Only displays printf statement",correct:false
},
{
