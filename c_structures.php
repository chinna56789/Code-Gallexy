...
<li class="activ"><a href="c_structures.php">Structures</a></li>
...
answers:[      
{ 
   text: "Group different items in single type",correct:true
   },  
   {
   text: "Group same items in single type",correct:false
   },
   { 
   text: "Divide same items in a single type",correct:false
   },  
   {
...
{
question:"Which of the following types are used in structure?",
answers:[     
{ 
     text: "Self-Referential Structures",correct:false
	 },   
     { 
     text: "Nested Structures",correct:false
	 },  
     {
     text: "Structure Pointer",correct:false
	 }, 
     {
...
{      
question:" struct student<br>int id;<br>char name[10];<br>float percentage;<br>error?",  
answers:[       
{ 
       text: "Keyword for structure is structure",correct:false
	   }, 	
       {
       text: "structure body must be enclosed with { } ",correct:true
},
{
       text: "structure items must be of same type",correct:false
},
{
       text: "structure body must be enclosed with [ ] ",correct:false
},
...
{ 
question:"struture is a user defined datatype.(TRUE or FALSE)", 
answers:[    
{
...
{        
question:"Syntax for defining the structure? ?", 
answers:[    
{
      text:"struct<br> {<br>data_type member_name1;<br>data_type member_namen;<br>}",correct:true
	  },     
      {
      text:"struct <br>data_type member_name1;<br>data_type member_namen;<br>",correct:false
	  },  
      { 
      text:"structure <br>data_type member_name1;<br>data_type member_namen;<br>",correct:false
	  },     
      {
      text:"structure<br> {<br>data_type member_name1;<br>data_type member_namen;<br>}",correct:false
	  }]
 }];
