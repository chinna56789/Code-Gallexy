...
<li class="activ"><a href="java_formattedoutput.php">FormattedOutput</a></li>
...
<button id="next-btn">Next</button>
      ...
      <form id="history-form" method="post" action="java_formattedoutput.php">
        <input type="hidden" name="username" value="<?php echo htmlentities($_SESSION['uname']); ?>">
        <input type="hidden" name="course" value="JAVA">   
        <input type="hidden" name="subtopic" value="Formatted Output">  
...
{
question:"System.out.print() statement is used for ?",
answers:[     
{ 
     text: "Not used",correct:false
	 },   
     { 
     text: "Reading the Data",correct:false
	 },  
     {
     text: "Returning a Value",correct:false
	 }, 
     {
     text: "Displaying the Output",correct:true
},] 
}, 
 
 
{      
question:" System.out.print(“Hello World”); ?",  
answers:[       
{ 
...
{ 
question:"We can use system instead of System.(TRUE or FALSE)?", 
answers:[    
{
...
{        
question:" Format Specifier Used for String Datatype ?", 
answers:[    
{
