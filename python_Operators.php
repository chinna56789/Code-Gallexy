...
<li class="activ"><a href="python_Operators.php">Operators</a></li>
...
const questions=[ 
{  
question:" Operators are ?", 
answers:[      
{ 
   text: "Memory Locations of Data",correct:false
   },  
   {
   text: "Symbols that performs operations",correct:true
   },
   { 
...
{
question:"Which of the following Operators are used in Python ?",
answers:[     
{ 
     text: "Arthimetic Operators",correct:false
	 },   
     { 
...
{      
question:" c=a+b<br> Which is the operator in the above Expression?",  
answers:[       
{ 
...
{ 
question:"= operator and == operator has same functionality.(TRUE or FALSE)?", 
answers:[    
{
